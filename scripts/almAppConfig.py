...
almPredixAssetName = "alm_asset_"+instanceAppender
almPredixTimeseriesName = "alm_time_series_"+instanceAppender
almPostgre = "alm_postgre_"+instanceAppender
almRedis = "alm_redis_"+instanceAppender
